...
INSERT INTO `clients` VALUES (1,'Андрей','89301001020'),(2,'Никита','89101002010');
...
INSERT INTO `employees` VALUES (1,'Михалыч','89101001020'),(2,'Батя Терминатор','89301002010');
...
INSERT INTO `incidents` VALUES (1,'Theft','Stolen goods',1,1,1,1),(2,'Vandalism','Graffity',2,1,1,1);
...
INSERT INTO `incidents_has_patrols` VALUES (2,1);
...
INSERT INTO `locations` VALUES (1,'Жилой массив'),(2,'Частная территория');
...
INSERT INTO `patrols` VALUES (1,'Зов'),(2,'Сланцы'),(3,'ЗА ВДВ!');
...
BEGIN
    ...
    BEGIN
        SET error_message = 'Как минимум один патруль должен быть отправлен на инцидент';
        ROLLBACK;
    ...
    IF patrol_count < 1 THEN
        SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Как минимум один патруль должен быть отправлен на инцидент';
    END IF;

    COMMIT;

    SELECT 'Хотя бы один патруль отправлен на инцидент.';
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2024-06-20  3:49:13
